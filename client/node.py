...
class Blockchain:
    ...
    def add_block(self, block, proof):
        ...
        if not Blockchain.is_valid_proof(block, proof):
            return False
        #If everything is fine, add the block.
        block.hash = proof
    ...
    def proof_of_work(self, block):
        ...
        computed_hash_value = block.compute_hash()
        #While the proof of work criteria is not met, compute the hash again and again
        while not computed_hash_value.startswith('0' * Blockchain.difficulty):
            block.nonce += 1
            computed_hash_value = block.compute_hash()
...
def new_transaction():
    ...
    required_fields = ["inventors", "content", "post_id", "privacy", "title"]
